...
const AdminDeleteConference = ({conference}: {conference: Conference}) => {

    const router = useRouter();

    const handleDelete = async (conferenceId: number) => {
        await axios.delete(`/api/adminallconferences/${conferenceId}`);
        router.refresh();
        setIsOpen(false);
    }
...
export default AdminDeleteConference;