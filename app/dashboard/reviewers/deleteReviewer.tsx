        ...
        <div>
            ...
            <div className={isOpen ? 'modal modal-open' : 'modal'}>
                <div className="modal-box bg-white">
                    <h3 className="text-lg">Are you sure to delete this Review?</h3>
                    <div className="modal-action">
                        <button type="button" className="btn text-white" onClick={handleModal}>No</button>
                        <button type="button" onClick={()=>handleDelete(conRev.id)} className="btn btn-accent text-white">Yes</button>
                    </div>
                </div>
            </div>
        </div>
