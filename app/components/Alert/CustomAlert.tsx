...
const CustomAlert = ({ type, message }: { type: keyof typeof alertTypes; message: string }) => {
    const { color, bgColor, iconPath } = alertTypes[type] || alertTypes.info;

    return (
        <div className={`flex items-center p-4 mb-4 text-sm ${color} rounded-lg ${bgColor}`} role="alert">
